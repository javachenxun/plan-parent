...
/**
 * @author：chenxun
 * <p>创建时间：2016年7月21日 下午10:50:24</p>
 * <p>参考：</p>
 * <p>说明：</p>
 */
public class XlsUtils {
	...
	private static void doing(WritableSheet sheet,int n) {
		try {
		    ...
		    labe0 = new Label(0, 0, "标题", wcfauto1);
			sheet.addCell(labe0);
			sheet.mergeCells(0, 0, 6, 0);
			labe0 = new Label(0, 1, "标题说明",wcfauto1);
			sheet.addCell(labe0);
			...
			for (int i = 2; i <60000; i++) {
				...
				sheet.addCell(labe2);
				labe0 = new Label(1, i, "列名称", wcfauto2);
				sheet.addCell(labe0);
				labe0 = new Label(2, i, "列名称", wcfauto2);
				sheet.addCell(labe0);
				labe0 = new Label(3, i, "列名称", wcfauto2);
				sheet.addCell(labe0);
				labe0 = new Label(4, i, "列名称", wcfauto2);
				sheet.addCell(labe0);
				labe0 = new Label(5, i, "列名称", wcfauto2);
				sheet.addCell(labe0);
				labe0 = new Label(6, i, "列名称", wcfauto2);
				sheet.addCell(labe0);
